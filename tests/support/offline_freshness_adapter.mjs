// TEST MODEL ONLY. No production imports, credentials, or real transports.
...
import { buildMergeRequest } from "../../experiments/exp-001-stage2/src/build_request.mjs";
import { isProductionVerified } from "../../experiments/exp-001-stage2/src/declaration.mjs";
import { deriveClaimRecord, claimAuthority, DISPATCH } from "../../experiments/exp-001-stage2/src/freshness.mjs";
...
export function createOfflineAdapter({ config, transport, beforeDispatch, claimBackend } = {}) {
